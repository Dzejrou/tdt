...
game.set_position(entity_256, 0.000000, 27.008251, 0.000000)
game.set_solid(entity_256, false)
game.set_half_height(entity_256, 27.008251)

game.add_component(entity_256, game.enum.component.health)
game.buff(entity_256, 1000)
game.sub_health(entity_256, 0)
game.add_defense(entity_256, 8)
game.set_regen(entity_256, 1)
game.set_alive(entity_256, true)

game.add_component(entity_256, game.enum.component.ai)
game.set_blueprint(entity_256, 'ogre')
game.set_state(entity_256, 1)
game.set_faction(entity_256, 0)

game.add_component(entity_256, game.enum.component.graphics)
game.set_mesh(entity_256, 'ogrehead.mesh')
game.set_material(entity_256, 'NO_MAT')
game.set_manual_scaling(entity_256, false)
game.set_visible(entity_256, true)
game.init_graphics_component(entity_256)

game.add_component(entity_256, game.enum.component.movement)
game.set_speed(entity_256, 0.500000)

game.add_component(entity_256, game.enum.component.combat)
game.set_range(entity_256, 800.000000)
game.set_dmg_range(entity_256, 15, 30)
game.set_cooldown(entity_256, 3.000000)
game.set_atk_type(entity_256, 2)

game.add_component(entity_256, game.enum.component.pathfinding)
...
game.add_possible_task(entity_256, 4)
game.add_possible_task(entity_256, 5)

game.add_component(entity_256, game.enum.component.event_handler)
game.set_event_handler(entity_256, 'ogre')
game.add_possible_event(entity_256, 1)

game.add_component(entity_257, game.enum.component.event)
game.set_event_type(entity_257, 1)
...
'entity_251', 'entity_252', 'entity_253', 'entity_254', 'entity_255', 'entity_256', 'entity_257', 'entity_258', }
